...
function num(t) {
  ...
  if (t.hasClass("active")) {
    var demoFi1 = new CountUp("num1", 0, $("#num1").data("num"), 0, 4);
    if (!demoFi1.error) {
      demoFi1.start();
    } else {
      console.error(demoFi1.error);
    }
    var demoFi2 = new CountUp("num2", 0, $("#num2").data("num"), 0, 4);
    if (!demoFi2.error) {
      demoFi2.start();
    } else {
      console.error(demoFi2.error);
    }
    var demoFi3 = new CountUp("num3", 0, $("#num3").data("num"), 0, 4);
    if (!demoFi3.error) {
      demoFi3.start();
    } else {
      console.error(demoFi3.error);
    }
    var demoFi4 = new CountUp("num4", 0, $("#num4").data("num"), 0, 4);
    if (!demoFi4.error) {
      demoFi4.start();
    } else {
      console.error(demoFi4.error);
    }
    var demoFi5 = new CountUp("num5", 0, $("#num5").data("num"), 0, 4);
    if (!demoFi5.error) {
      demoFi5.start();
    } else {
      console.error(demoFi5.error);
    }
    var demoFi6 = new CountUp("num6", 0, $("#num6").data("num"), 0, 4);
    if (!demoFi6.error) {
      demoFi6.start();
    } else {
